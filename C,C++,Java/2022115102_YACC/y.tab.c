...
{
  "\"end of file\"", "error", "\"invalid token\"", "ALPHABET", "'|'",
  "'.'", "'*'", "'+'", "'\\n'", "'('", "')'", "$accept", "S", "re", YY_NULLPTR
};
